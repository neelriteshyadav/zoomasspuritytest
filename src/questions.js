const questions = [
          ...
          'Engaged in cunnilingus (eating out)?',
          'Engaged in fellatio (blow-job)?',
          'Engaged in tocuslingus (rim job)?',
          'Kissed for more than two hours consecutively?',
          'Kissed someone who is not your MPS on the lips?',
          ...
          'Tits out for blarneys?',
          'Been thrown out of Spoke?',
          'Flirted with a bouncer to get in a club?',
          'Went on a date with your MPS from all of the five colleges?',
          'Hooked up with an athlete?',
          'Ever stolen something?',
          'Ever had sex with someone you weren\'t attracted to?',
          'Ever lied to someone about your sexual history?',
          'Used alcohol to lower a MPS\'s resistance?',
          'Dry humped?',
          'Tried BDSM?',
          'Tried partner swap?'
        ];
